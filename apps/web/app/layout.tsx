...
export default function RootLayout({ children }: Readonly<{ children: ReactNode }>) {
  return <html lang="zh-Hant"><body><AppProviders><div className="app-shell">
    <aside className="sidebar"><Link className="brand" href="/"><span>ST</span><div><strong>Sky Turbo</strong><small>Market Intelligence</small></div></Link>
      <nav><Link href="/"><span>01</span>Bazaar Flips</Link><Link href="/shards"><span>02</span>Shard Flip</Link><Link href="/crafts"><span>03</span>Craft Flip</Link><Link href="/npc-flips"><span>04</span>NPC Flip</Link><Link href="/crashing"><span>05</span>Crashing</Link><Link href="/bookmarks"><span>06</span>Bookmarked</Link></nav>
