...
export default function RootLayout({ children }: Readonly<{ children: ReactNode }>) {
  return <html lang="zh-Hant"><body><AppProviders><div className="app-shell">
    <aside className="sidebar"><Link className="brand" href="/"><span>ST</span><div><strong>Sky Turbo</strong><small>Market Intelligence</small></div></Link>
      <nav><Link href="/"><span>01</span>Bazaar Flips</Link><Link href="/shards"><span>02</span>Shard Flip</Link><Link href="/npc-flips"><span>03</span>NPC Flip</Link><Link href="/crashing"><span>04</span>Crashing</Link><Link href="/bookmarks"><span>05</span>Bookmarked</Link></nav>
      <div className="sidebar-foot"><span className="status-dot" />Hypixel data · 20s refresh<small>Not affiliated with Hypixel.</small></div>
    </aside>
